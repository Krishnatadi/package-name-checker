...
const PyPiChecker = () => {
  ...
  const checkPackageName = async () => {
    ...
    try {
      const response = await fetch(`https://corsmirror.com/v1?url=https://pypi.org/pypi/${packageName}/json`);
      Swal.close();
  ...
  return (
    <div className="text-center">
      <h2>Check PyPI Package Availability</h2>
      <input 
        type="text" 
